...
vim.keymap.set('n', '<leader>fu', vim.cmd.Git, { desc = '[FU]gitive Git Status' })
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        --   init_options = {
        --     bundles = {
        --       vim.fn.glob('~/.local/share/nvim/mason/packages/vscode-spring-boot-tools/extension/language-server/*.jar', 1),
        --     },
        --   },
        -- },
    ...
    opts = {
      ...
      sources = {
        ...
        providers = {
          ...
          -- copilot = { module = 'blink-cmp-copilot', score_offset = -100, name = 'copilot', async = true},
        },
      },
